...
import storeCreditsRoutes from './routes/store-credits.js';
...
app.get('/api', (_req, res) => {
  res.json({
    ...
    endpoints: {
      ...
      storeCredits: '/api/store-credits',
...
app.use('/api/store-credits', storeCreditsRoutes); // Vales de crédito (devoluciones)
